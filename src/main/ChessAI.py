...
from src.dimen.dimen import CHECKMATE, STALEMATE, piece_score, DEPTH
...
class ChessAI:
    ...
    def find_best_move(self, valid_moves):
        ...
        self.find_move_negative_max(valid_moves, DEPTH, 1 if temp_game_rules.whiteToMove else -1, temp_validator,
                                    temp_game_rules, temp_board)
